...
dotenv.config();
var fileCart = new _fileManager.FileManager("./src/data/cart.data.js");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fileCart.getById(req.params.id);
...
var addCart = /*#__PURE__*/function () {
  ...
  return function addCart(_x3, _x4) {
...
var addProductIncart = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.t0 = res;
            _context3.next = 4;
            return fileCart.addProductInCart(req.params.id, req.body);
  ...
  return function addProductIncart(_x5, _x6) {
...
var deleteProductInCart = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.t0 = res;
            _context4.next = 4;
            return fileCart.deleteProductInCart(req.params.id, req.params.id_prod);
  ...
  return function deleteProductInCart(_x7, _x8) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.t0 = res;
            _context5.next = 4;
            return fileCart.deleteById(req.params.id);
