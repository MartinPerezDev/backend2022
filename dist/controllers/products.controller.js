...
var fileProducts = new _fileManager.FileManager("./src/data/products.js");
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            product = fileProducts.getById(req.params.id);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 4;
            return fileProducts.addProduct(req.body);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 4;
            return fileProducts.set(req.body, req.params.id);
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 4;
            return fileProducts.deleteById(req.params.id);
